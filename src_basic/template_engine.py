...
class TemplateEngine:
    ...
    def render(self, nama_peserta: str, **extra_vars) -> str:
        """
        Render template dengan data peserta.

        Args:
            nama_peserta: Nama peserta
            **extra_vars: Variabel tambahan dari kolom CSV kustom
    ...
    def preview(self, nama_peserta: str = "CONTOH NAMA", **extra_vars) -> str:
        """Render template dengan data dummy untuk preview."""
        return self.render(nama_peserta=nama_peserta, **extra_vars)
